...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-12">
					<h1>Bienvenido al control de alumnos</h1>
				</div>
				<div class="col-12">
					<table border=1 class="table table-borderless table-dark">			
						<tr>
							<td><a href="ingresar.php" class="btn btn-primary">Nuevo alumno <i class="fas fa-user-plus"></i></a></td>
						</tr>
						<tr>
							<td><a href="mostrar.php" class="btn btn-primary">Ver todos <i class="fas fa-search"></i></a></td>
						</tr>
					</table>
				</div>
			</div>
